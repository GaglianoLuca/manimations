...
class SANISAND(ThreeDScene):
    ...
    def construct(self):
        ...
        pq_background = Rectangle(
            width=pq_axes.width+pq_axes.width/3,
            height=pq_axes.height+pq_axes.height/15,
            fill_color=RED,
            fill_opacity=0.1,
            stroke_width=1,
            stroke_color=RED,
        ...
        pq_background.move_to(pq_axes.get_center())
        ...
        def make_csl_line():
            ...
            # M e' il parametro del materiale: costante
            Mth = M
        ...
        MERIDIAN_HALF = p_max_yield+p_max_yield/3
        MERIDIAN_P_MIN = 0
